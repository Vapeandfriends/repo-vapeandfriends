...
const kUserKey = "MDlhMjQwZjMtYzBjYy00Yzg2LTgwMWEtMmFkNzE5ZTE3NjQ0";
const kAPIKey = "NTgzNzIxZmUtYjJlYS00MmUxLTliOTUtZTI0YTAzZDgzY2Ez";
...
exports.addUser = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const createdUser = await client.createUser(
      "27dbc645-a7b6-4190-95d6-faf8fe71071b",
      user,
    );
