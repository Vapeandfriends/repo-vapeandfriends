...
import 'mas_vendidos_model.dart';
export 'mas_vendidos_model.dart';

class MasVendidosWidget extends StatefulWidget {
  const MasVendidosWidget({
    super.key,
    String? masvendidos,
  }) : this.masvendidos = masvendidos ?? 'Más Vendidos';

  final String masvendidos;

  @override
  State<MasVendidosWidget> createState() => _MasVendidosWidgetState();
}

class _MasVendidosWidgetState extends State<MasVendidosWidget> {
  late MasVendidosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasVendidosModel());
      ...
      child: StreamBuilder<List<ProductosRecord>>(
        stream: queryProductosRecord(
          queryBuilder: (productosRecord) => productosRecord
              .where(
                'ListaCategorias',
                arrayContains: widget.masvendidos,
              )
              .orderBy('name'),
          limit: 6,
        ),
