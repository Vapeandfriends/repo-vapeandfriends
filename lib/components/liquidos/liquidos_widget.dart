...
import 'liquidos_model.dart';
export 'liquidos_model.dart';

class LiquidosWidget extends StatefulWidget {
  const LiquidosWidget({
    super.key,
    String? liquidos,
  }) : this.liquidos = liquidos ?? 'Líquidos';

  final String liquidos;

  @override
  State<LiquidosWidget> createState() => _LiquidosWidgetState();
}

class _LiquidosWidgetState extends State<LiquidosWidget> {
  late LiquidosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LiquidosModel());
