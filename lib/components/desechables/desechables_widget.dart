...
import 'desechables_model.dart';
export 'desechables_model.dart';

class DesechablesWidget extends StatefulWidget {
  const DesechablesWidget({
    super.key,
    String? desechables,
  }) : this.desechables = desechables ?? 'Desechables';

  final String desechables;

  @override
  State<DesechablesWidget> createState() => _DesechablesWidgetState();
}

class _DesechablesWidgetState extends State<DesechablesWidget> {
  late DesechablesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DesechablesModel());
      ...
      child: StreamBuilder<List<ProductosRecord>>(
        stream: queryProductosRecord(
          queryBuilder: (productosRecord) => productosRecord
              .where(
                'ListaCategorias',
                arrayContains: widget.desechables,
              )
              .orderBy('name'),
          limit: 6,
        ),
