...
import 'baterias_model.dart';
export 'baterias_model.dart';

class BateriasWidget extends StatefulWidget {
  const BateriasWidget({
    super.key,
    String? baterias,
  }) : this.baterias = baterias ?? 'Baterías';

  final String baterias;

  @override
  State<BateriasWidget> createState() => _BateriasWidgetState();
}

class _BateriasWidgetState extends State<BateriasWidget> {
  late BateriasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BateriasModel());
