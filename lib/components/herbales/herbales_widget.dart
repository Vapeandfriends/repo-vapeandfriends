...
import 'herbales_model.dart';
export 'herbales_model.dart';

class HerbalesWidget extends StatefulWidget {
  const HerbalesWidget({
    super.key,
    String? herbales,
  }) : this.herbales = herbales ?? 'Herbales';

  final String herbales;

  @override
  State<HerbalesWidget> createState() => _HerbalesWidgetState();
}

class _HerbalesWidgetState extends State<HerbalesWidget> {
  late HerbalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HerbalesModel());
