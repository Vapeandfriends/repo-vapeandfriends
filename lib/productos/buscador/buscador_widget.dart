    ...
    return StreamBuilder<List<ProductosRecord>>(
      stream: queryProductosRecord(
        queryBuilder: (productosRecord) =>
            productosRecord.orderBy('description'),
      ),
      builder: (context, snapshot) {
        ...
        List<ProductosRecord> buscadorProductosRecordList = snapshot.data!;
        return Title(
            title: 'Buscador',
